...
namespace MarshmallowAvalanche {
    public class GameRoot : Game {
        ...
        protected override void Initialize() {
            ...
            marshmallow = new Character(new Vector2(DesiredWindowWidth / 2, DesiredWindowHeight / 2), whiteRectangle.Size);
            ...
            // add floor
            world.SpawnObject(new StaticObject(new Vector2(-50, DesiredWindowHeight - (DesiredWindowHeight/4f)), new Vector2(DesiredWindowWidth + 100, 100)));
        ...
        protected override void Draw(GameTime gameTime) {
            ...
            world.DrawAllSpawnedObjects(sb, Color.OrangeRed, (p) => !(p is Character));
